<?php
/* $Id: tbl_select.php3,v 1.1.1.1 2000-11-06 20:55:48 linktrai Exp $ */
...
if(!isset($param) || $param[0] == "")
  {
   ...
   if (!$result)
    ...
    {
     ?>
       <form method="GET" ACTION="tbl_select.php3">
       ...
       <div align="left">
       <ul><li><?php echo $strAddSearchConditions; ?><br>
       <input type="text" name="where"> <?php print show_docu("manual_Syntax.html#Functions");?><br>
...
?>
...
else
 {
	...
	$sql_query .= " where 1";
       ...
       Header("Location:sql.php3?sql_query=".urlencode($sql_query)."&goto=db_details.php3&server=$server&db=$db&table=$table&pos=0");
  }
